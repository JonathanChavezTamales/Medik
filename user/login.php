...
if(isset($_SESSION['users'])):
    ...
    if(isset($_POST['login'])):
        ...
        elseif(strlen($_POST['phone']) > 30):
            ...
            $login = mysqli_query($connection, "SELECT phone,password FROM users WHERE phone = '".mysqli_real_escape_string($connection, $_POST['phone'])."' AND password = '".mysqli_real_escape_string($connection, hash('ripemd160', $_POST['password']))."'");
